...
export default async function OnboardingPage() {
  ...
  // Strategy: match employee.practice_area_id -> onboarding_role.practice_area_id -> track -> modules.
  // If no role match, fall back to the first available track (single-track demo case).
