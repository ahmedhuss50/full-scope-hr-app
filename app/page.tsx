    ...
    <main className="min-h-screen flex items-center justify-center p-6">
      <div className="max-w-xl text-center">
        <div className="inline-flex items-center gap-2 mb-6">
          ...
          <span className="serif text-2xl font-bold">Full Scope</span>
        </div>
        <h1 className="serif font-black text-4xl md:text-5xl tracking-tight leading-tight">
          The operating suite for professional services firms.
        </h1>
        <p className="mt-4 text-ink/70 text-lg">
          HR, CRM, and Accounting for accounting and BD firms across the GCC. HR module is live;
          CRM and Accounting are in development.
        </p>
